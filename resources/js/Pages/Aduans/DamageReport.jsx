...
export default function DamageReport({ aduan }) {
    ...
    useEffect(() => {
        ...
        // Auto-trigger print/PDF download dialog on load
    ...
    return (
        <AdminLayout title="Berita Acara Kerusakan">
            <Head title={`Berita Acara - ${aduan.ticket_number}`} />
